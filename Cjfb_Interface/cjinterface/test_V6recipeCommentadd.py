...
class recipeCommentaddTest(CJMyTest):
    ...
    def test_recipeCommentadd_success(self):
        ...
        r = self.cjmyhttp('POST',
                        self.url_path,
                         {'deviceId': '9382018','recipeId':1908,'content':'good','stars':0,'language':''},
                         )
        print r
        js = json.loads(r)
...
class recipeCommentpagegetTest(CJMyTest):
    ...
    def test_recipelistdata_success11(self):
        ...
        # self.url_path = 'http://framipotplugapi.joyami.com/v6/recipeComment/listdata'
        url = self.url_path
