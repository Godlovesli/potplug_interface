...
class recipecookscriptfindTest(CJMyTest):
    '''获取食谱烹饪程序'''
    url_path =  '/v6/recipecookscript/findByModel'

    @classmethod
    def setUpClass(cls):
        pass

    def test_recipecookscriptfindByModel_success(self):
        '''获取食谱烹饪程序'''
        r = self.cjmyhttp('GET',
                         self.url_path,
                          {'model': self.model_name, 'recipeId': 257,'language': self.language},
                         )
        print r
        js = json.loads(r)
        ...
        for i in js['result']:
            print i
        print "打印cookcode：%s" %i['cookscript']['cookcode']

        #     print l.append(i)
        # print l
        # print l[0]cookscript
